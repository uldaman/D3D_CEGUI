...
const DWORD BASE_REWARD_TASK = 0x02582D14;   // 悬赏任务信息基址   地址: 559794
//调用
...
const DWORD CALL_DO_ACTION = 0x01501E9B;   // 执行攻击，闪避等动作   地址: 155E356
//偏移
...
const DWORD OFFSET_CURRENT_MAP_OBJECTS2 = 0x08B018B74;   // 当前地图中的所有对象遍历2偏移（取BYTE）   地址: 465A84
...
const DWORD OFFSET_CURRENT_MAP_ENTITY_ARRAY = 0x0873C835C;   // 当前地图中的对象数组首地址偏移（取BYTE）   地址: 9289C6
...
const DWORD HOOK_SWITCH_REGION = 0x013FB095;   // 顺图脚本录制HOOK处(取左边的值)   地址: 13FB095

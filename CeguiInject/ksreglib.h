...
#endif
//
extern std::string v_inipath;
extern _int32  v_softcode;          //公共变量，软件编号
extern std::string v_softkey;       //公共变量，软件密钥
extern std::string v_bdinfo;        //公共变量，用户绑定信息
//
extern std::string  signData;
...
_int32       kpoints(_int32 v_points, std::string *v_errinfo);

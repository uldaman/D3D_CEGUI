...
public:
    ...
    void setupUi(QWidget *CeguiInjectClass)
    {
        ...
        CeguiInjectClass->resize(355, 200);
        CeguiInjectClass->setMinimumSize(QSize(355, 200));
        CeguiInjectClass->setMaximumSize(QSize(355, 200));
        groupBox = new QGroupBox(CeguiInjectClass);
        groupBox->setObjectName(QStringLiteral("groupBox"));
        groupBox->setGeometry(QRect(10, 30, 331, 51));
        layoutWidget = new QWidget(groupBox);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(100, 20, 151, 18));
        ...
        radioButton_d3d9->setEnabled(true);
        ...
        lineEdit_path->setGeometry(QRect(11, 20, 261, 20));
        ...
        pushButton_install->setEnabled(true);
        pushButton_install->setGeometry(QRect(210, 160, 61, 31));
        ...
        QObject::connect(pushButton_install, SIGNAL(clicked()), CeguiInjectClass, SLOT(installDll()));
    ...
    void retranslateUi(QWidget *CeguiInjectClass)
    {
        ...
        label_output->setText(QApplication::translate("CeguiInjectClass", "\350\257\264\346\230\216: \351\246\226\346\254\241\344\275\277\347\224\250\350\257\267\345\205\210\347\202\271\345\207\273\345\256\211\350\243\205\346\217\222\344\273\266.", 0));
